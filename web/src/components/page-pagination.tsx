...
// 视觉与 Pagination 一致：左侧页码信息 + 每页条数下拉，
// 右侧页码按钮组（md 及以上可见）+ 「跳至第 N 页」（sm 及以上可见）+ outline 翻页按钮。

// 页码按钮组计算见 lib/page-numbers.ts（与 Pagination 共用）。
          ...
          {pageNumbers(page, totalPages).map((p, i) =>
            p === 'ellipsis' ? (
              ...
              <Button
                ...
                onClick={() => { setJumpTo(''); onPageChange(p) }}
              >
                {p}
              </Button>
            )
