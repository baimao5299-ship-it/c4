  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:data-active:bg-white/80 group-data-[variant=default]/tabs-list:data-active:text-primary group-data-[variant=default]/tabs-list:data-active:shadow-[inset_0_1px_3px_rgba(255,255,255,0.6),0_2px_10px_rgba(0,0,0,0.08)]",
