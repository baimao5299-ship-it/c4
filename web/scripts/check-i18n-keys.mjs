...
const files = ['src/pages/dashboard.tsx', 'src/pages/logs.tsx', 'src/pages/user/logs.tsx', 'src/pages/pricing.tsx', 'src/pages/templates.tsx', 'src/pages/accounts.tsx', 'src/pages/groups.tsx', 'src/pages/stats.tsx', 'src/pages/user/stats.tsx', 'src/pages/ops.tsx', 'src/pages/user/profile.tsx']
