...
func (_u *RuleUpdate) SetWhen(v map[string]interface{}) *RuleUpdate {
	_u.mutation.SetWhen(v)
	return _u
}

// SetThen sets the "then" field.
func (_u *RuleUpdate) SetThen(v map[string]interface{}) *RuleUpdate {
	_u.mutation.SetThen(v)
	return _u
}
...
// SetWhen sets the "when" field.
func (_u *RuleUpdateOne) SetWhen(v map[string]interface{}) *RuleUpdateOne {
	_u.mutation.SetWhen(v)
	return _u
}

// SetThen sets the "then" field.
func (_u *RuleUpdateOne) SetThen(v map[string]interface{}) *RuleUpdateOne {
	_u.mutation.SetThen(v)
	return _u
}
