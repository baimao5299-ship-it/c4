...
func (_c *SettingCreate) SetID(v int64) *SettingCreate {
	_c.mutation.SetID(v)
	return _c
}
...
// SetType sets the "type" field.
func (u *SettingUpsert) SetType(v setting.Type) *SettingUpsert {
...
// SetType sets the "type" field.
func (u *SettingUpsertOne) SetType(v setting.Type) *SettingUpsertOne {
	return u.Update(func(s *SettingUpsert) {
		s.SetType(v)
	})
}
...
// SetType sets the "type" field.
func (u *SettingUpsertBulk) SetType(v setting.Type) *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.SetType(v)
	})
}
