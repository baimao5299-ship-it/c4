...
func (_q *KeyQuery) QueryGroup() *GroupQuery {
...
func (_q *KeyQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *KeyQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *KeyQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *KeyQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *KeyQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *KeyQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *KeyQuery) WithGroup(opts ...func(*GroupQuery)) *KeyQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *KeyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Key, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Key, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *KeyQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*Key, init func(*Key), assign func(*Key, *Group)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Key)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (_q *KeyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(key.Table, key.Columns, sqlgraph.NewFieldSpec(key.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(key.FieldUserID)
		}
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(key.FieldGroupID)
		}
	}
