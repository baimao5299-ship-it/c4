...
func (_q *AccountQuery) QueryTemplate() *TemplateQuery {
...
func (_q *AccountQuery) WithTemplate(opts ...func(*TemplateQuery)) *AccountQuery {
	query := (&TemplateClient{config: _q.config}).Query()
...
func (_q *AccountQuery) loadTemplate(ctx context.Context, query *TemplateQuery, nodes []*Account, init func(*Account), assign func(*Account, *Template)) error {
