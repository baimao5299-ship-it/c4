...
func (_q *TemplateQuery) QueryAccounts() *AccountQuery {
...
func (_q *TemplateQuery) WithAccounts(opts ...func(*AccountQuery)) *TemplateQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *TemplateQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Template, error) {
	...
	if query := _q.withAccounts; query != nil {
		if err := _q.loadAccounts(ctx, query, nodes,
			func(n *Template) { n.Edges.Accounts = []*Account{} },
			func(n *Template, e *Account) { n.Edges.Accounts = append(n.Edges.Accounts, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TemplateQuery) loadAccounts(ctx context.Context, query *AccountQuery, nodes []*Template, init func(*Template), assign func(*Template, *Account)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(account.FieldTemplateID)
	}
