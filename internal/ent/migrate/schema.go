...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "format", Type: field.TypeEnum, Enums: []string{"openai-chat", "openai-responses", "openai-responses-ws", "anthropic", "openai-images"}},
		{Name: "error_type", Type: field.TypeString, Default: "none"},
		{Name: "latency_ms", Type: field.TypeInt64, Default: 0},
		...
		{Name: "image_input_tokens", Type: field.TypeInt64, Default: 0},
		{Name: "image_output_tokens", Type: field.TypeInt64, Default: 0},
		{Name: "image_count", Type: field.TypeInt64, Default: 0},
		{Name: "price_image_input_millis", Type: field.TypeInt64, Nullable: true},
		{Name: "price_image_output_millis", Type: field.TypeInt64, Nullable: true},
		{Name: "price_per_image_millis", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[2], UsageLogsColumns[32]},
			},
			{
				Name:    "usagelog_account_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[3], UsageLogsColumns[32]},
			},
			{
				Name:    "usagelog_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[5], UsageLogsColumns[32]},
			},
			{
