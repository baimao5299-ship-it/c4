...
var (
	...
	ErrLogsColumns = []*schema.Column{
		...
		{Name: "client_ip_source", Type: field.TypeString, Nullable: true},
		{Name: "client_ip_trusted", Type: field.TypeBool, Nullable: true},
		...
		{Name: "upstream_id", Type: field.TypeInt64, Nullable: true},
		{Name: "upstream_name", Type: field.TypeString, Nullable: true},
		{Name: "upstream_host", Type: field.TypeString, Nullable: true},
		{Name: "upstream_multiplier_bp", Type: field.TypeInt, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ErrLogsColumns[22]},
			},
			{
				Name:    "errlog_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ErrLogsColumns[5], ErrLogsColumns[22]},
			},
			{
				Name:    "errlog_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ErrLogsColumns[13], ErrLogsColumns[22]},
			},
		},
	}
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "display_order", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "cost", Type: field.TypeInt64, Default: 0},
		{Name: "raw_cost", Type: field.TypeInt64, Default: 0},
		{Name: "upstream_cost", Type: field.TypeInt64, Nullable: true},
		{Name: "gross_profit", Type: field.TypeInt64, Nullable: true},
		{Name: "profit_margin_bp", Type: field.TypeInt64, Nullable: true},
		{Name: "billing_tier", Type: field.TypeString, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[13], UsageLogsColumns[41]},
			},
			{
				Name:    "usagelog_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[14], UsageLogsColumns[41]},
			},
			{
