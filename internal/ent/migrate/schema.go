	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[2], UsageLogsColumns[22]},
			},
			{
				Name:    "usagelog_account_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[3], UsageLogsColumns[22]},
			},
			{
				Name:    "usagelog_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[5], UsageLogsColumns[22]},
			},
			{
				Name:    "usagelog_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[6], UsageLogsColumns[22]},
			},
		},
	}
