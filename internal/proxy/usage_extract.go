...
func anthropicStartUsage(data []byte) (pt, cr, cc int64) {
...
func responsesCompletedUsage(data []byte) (pt, ct, tt, cr, cc int64) {
...
func chatUsageFromResponse(u openai.CompletionUsage) (pt, ct, tt, cr, cc int64) {
...
func responsesUsageFromResponse(u responses.ResponseUsage) (pt, ct, tt, cr, cc int64) {
...
func anthropicUsageFromResponse(u anthropic.Usage) (pt, ct, tt, cr, cc int64) {
	return u.InputTokens, u.OutputTokens, u.InputTokens + u.OutputTokens,
