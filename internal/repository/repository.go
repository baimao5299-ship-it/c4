...
// CreateTempBalance 插入临时额度行（兑换码 temp_balance 兑换用；tx 版 Repository
// 同构造天然走 tx —— 评审 I-1）。
func (r *Repository) CreateTempBalance(ctx context.Context, userID, amount int64, expiresAt time.Time, note string) error {
