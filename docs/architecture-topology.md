...
- user 组（`internal/handler/user/api.gen.go:1303`）：`/user/auth/login|register|me`、`/user/keys`（含 `{id}`、`{id}/rotate`）、`/user/groups`、`/user/usage_logs`、`/user/err_logs`、`/user/stats`、`/user/redemptions`。
