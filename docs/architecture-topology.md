...
- 转换 on/off 开销实证（`docs/superpowers/plans/2026-08-11-w3-loadtest.md` §二 与 `docs/superpowers/plans/2026-08-11-protoconv-opt-loadtest.md` §一，均压测机 51.222.42.218 实证）：
...
- **目标与实测**（`docs/superpowers/plans/2026-08-11-w3-loadtest.md` §一，压测机 51.222.42.218 / 24 逻辑 CPU / 62GB，DB postgres:18 同机，loadtest 工具交错跑 + 每请求 CPU 同口径）：
